...
const NavBar = () => {
  ...
  return (
    ...
    <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
     ...
     {
      isOpen ?
      <motion.div initial={{scale:0,opacity:0,x:"-50%",y:"-50%"}} animate={{scale:1,opacity:1}} className='min-w-[70vw] flex flex-col justify-between items-center z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
      ...
      <nav className='flex items-center justify-center flex-wrap mt-2'>
        ...
        <motion.a href='https://github.com/hamza301211' whileHover={{y:-2}} target='_blank' whileTap={{scale:0.9}} className='w-6 mx-3 sm:mx-1 bg-light rounded-full dark:bg-dark'><GithubIcon/></motion.a>
